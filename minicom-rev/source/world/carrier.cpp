...
bool Carrier::LaunchBomber( WorldObjectReference const & targetObjectId, Fixed longitude, Fixed latitude )
{
...
bool Carrier::LaunchFighter( WorldObjectReference const & _targetObjectId, Fixed longitude, Fixed latitude )
{
