...
public:
    enum
    {
        ...
        TypeBlip,
        TypeGunFire,
		DefaultTypes, //mod units must be inserted between this and NumObjectTypes
        NumObjectTypes
    };
...
public:
   ...
   /* virtual bool        CanLaunchBomber ();*/
	...
	virtual bool		CanLaunchAnywhere();
