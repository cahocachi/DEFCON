...
//returns whether unit can land on unit of type _type
bool WorldObject::CanLandOn (int _type)
{
	return false;
}

bool WorldObject::CanLaunchAnywhere ()
{
	return false;
}