...
void DepthCharge::Render( RenderInfo & renderInfo )
{
    ...
    g_renderer->Blit( bmpImage, m_longitude.DoubleValue()+renderInfo.m_xOffset, m_latitude.DoubleValue(), size, size, colour, angle);
}
